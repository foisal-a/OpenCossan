...
CPD_Camera(2,1,[1,2]) = {0.93 0.07};
CPD_Camera(1,2,[1,2]) = {0.92 0.08};
CPD_Camera(2,2,[1,2]) = {0.98 0.02};
...
CPD_FPGA(2,1,[1,2]) = {0.90 0.10};
CPD_FPGA(1,2,[1,2]) = {0.95 0.05};
...
CPD_Battery(1,1,2,[1,2]) = {0.93 0.07};
CPD_Battery(1,2,1,[1,2]) = {0.92 0.08};
CPD_Battery(1,2,2,[1,2]) = {0.93 0.07};
CPD_Battery(2,1,1,[1,2]) = {0.91 0.01};
CPD_Battery(2,1,2,[1,2]) = {0.93 0.07};
CPD_Battery(2,2,1,[1,2]) = {0.95 0.05};
CPD_Battery(2,2,2,[1,2]) = {0.99 0.01};
